...
export default function Certificate({ userName, domain, level, date }: CertificateProps) {
  return (
    <div className={cn(
        ...
        "w-full aspect-[1.414_/_1] max-w-[800px] mx-auto flex flex-col items-center justify-center text-center font-serif"
      )}>
      <div className="w-full h-full border-2 border-primary/30 p-6 flex flex-col items-center justify-between">
